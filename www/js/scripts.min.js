...
$(document).ready(function(){
	$('.cardnav').each(function(){
		var navcards = $(this).siblings().find('.js-navcards');
...
$('.cardnav__arrow').click(function(e){
	e.preventDefault();
	var navcards = $(this).parent().siblings().find('.js-navcards');
	var containerWidth = navcards.width();
	var cardsWidth = 0;
	navcards.children().each(function(){
		cardsWidth = cardsWidth + $(this).outerWidth(true);
...
sr.reveal('.detail__authorinfo, .topauthors__usercard, .topauthors__morecard, .comments__form, .interesting__morecard', fooReveal1);*/
