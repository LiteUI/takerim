...
sr.reveal('.reviews__card, .detail__header, .detail__reviewinfo, .detail__textblock, .detail__imageblock, .detail__linkblock, .share__block, .share__bottom, .subscribe__form, .topauthors__heading, .interesting__heading, .comments__heading, .comments__block, .comments__firsttext, .comments__loginblock', fooReveal);
sr.reveal('.detail__authorinfo, .topauthors__cards, .interesting .reviews__cards, .comments__form', fooReveal1);
