...
$(window).scroll(function(){
    ...
    } else { $(".actions").removeClass("active"); }
});
...
$('.searchblock__option a').click(function(e){
	...
	if ( $(this).parent().hasClass('searchblock__option_categories') ) {
		...
		$('.searchblock__categories-overlay').toggleClass('active');
	} else {
		$('.searchblock__categories').removeClass('active');
		$('.searchblock__categories-overlay').removeClass('active');
	}
})
$('html').click(function(){
	$('.searchblock__menu_date').removeClass('active');
})
$('.searchblock__categories-overlay').click(function(){
...
$(document).ready(function(){
	...
	var distance = $('.searchblock__categories').offset().top;
	var blockheight = wheight - distance;
	$('.searchblock__categories').css('bottom', '-'+(blockheight-100)+'px');
})*/
...
$('.searchblock__menu [data-value]').click(function(e){
	e.preventDefault();
	var defval = $(this).parents('.searchblock__menu').find('[data-default]').data('default');
	var val = $(this).data('value');
	$(this).parents('.searchblock__menu').find('[data-default]').text(defval+" "+val);
...
$('.searchblock__icon_minus').click(function(e){
	var defval = $('.searchblock__menu').find('[data-default]').data('default');
	$('.searchblock__menu').find('[data-default]').text(defval);
...
// Оценка обзора
$('.share__icon_star').hover(function(){
	$(this).addClass('hover');
	$(this).prevAll('.share__icon_star').addClass('hover');
	},
	function(){
	$(this).removeClass('hover');
	$(this).prevAll('.share__icon_star').removeClass('hover');
})

$('.share__icon_star').click(function(e){
	e.preventDefault();
	var starindex = $(this).index('.share__icon_star');
	starindex++;
	
	if ( starindex == 1 ) {
		$('.share__icon_star').removeClass('two three four five');
		$(this).addClass('one');
		$(this).prevAll('.share__icon_star').addClass('one');
	...
	if ( starindex == 2 ) {
		...
		$(this).addClass('two');
		$(this).prevAll('.share__icon_star').addClass('two');
	...
	if ( starindex == 3 ) {
		...
		$(this).addClass('three');
		$(this).prevAll('.share__icon_star').addClass('three');
	...
	if ( starindex == 4 ) {
		...
		$(this).addClass('four');
		$(this).prevAll('.share__icon_star').addClass('four');
	...
	if ( starindex == 5 ) {
		...
		$(this).addClass('five');
		$(this).prevAll('.share__icon_star').addClass('five');
		$('.share__myrating').removeClass('one two three four');
		$('.share__myrating').addClass('five');
	}
	
	$('.share__myrating span').text(starindex);
