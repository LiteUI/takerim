...
$(".second__detail-button").click(function(e){
	...
	$('html,body').animate({scrollTop:allblock.offset().top - 110}, 1200);
...
var eballblock = $(".ebay-allinfo");
var ebbutton = $(".second__detail-button");
var ebpercent;

var eboffset1 = eballblock.offset().top;
var eboffset2 = ebbutton.offset().top;
...
$(window).resize(function(){
	eboffset1 = eballblock.offset().top;
	eboffset2 = ebbutton.offset().top;
	wH = $(window).height();
});

var percent1;

if (eballblock.length > 0) {

	$(window).scroll(function(){
		sT = $(window).scrollTop();
		percent1 = sT/(eboffset1-wH);
		if (percent1 > 0) {percent1 = 0}
		percent = 1 - (sT)/(eboffset1) + percent1;
		console.log(sT + " _ " + percent + " " + eboffset1 + " " + wH);
		if (percent < 0) {percent = 0}
		ebbutton.css("opacity", percent);
	});
...
$("a.alternav").click(function(event){     
    event.preventDefault();
	if ($(this).attr('href') == '#comments') {
		var allblock = $(".ebay-allinfo");
	
		$(".second__detail-button").addClass("active");
		allblock.show();
		setTimeout(function(){
			allblock.addClass("active");
			$('html,body').animate({scrollTop:($('#comments').offset().top)-60}, 2000);
		}, 1);
	} else {
		$('html,body').animate({scrollTop:($(this.hash).offset().top)-60}, 2000);
	}
});
...
function showgood() {
    $(".second").addClass("good").removeClass("bad");
...
// Показать плохой
function showbad() {
    $(".second").removeClass("good").addClass("bad");
    $(".yesorno").text("Не нужно покупать");
    var rating = "48";
    $(".ratingnumber").text(rating);
    var textrating = "не рекомендуем";
    $(".textrating").text(textrating);
}
...
$('.shadow-hover').hover(function(){ 
	$(this).addClass('hover').css("z-index", zindex); 
	//zindex += 1;
}, function(){
	var th = $(this);
	setTimeout(function(){ 
...
$(document).ready(function() {
    $('.page_ebay .formscreen form').ajaxForm(function() {
        ...
        if ($(".page_ebay .formscreen_ebay input[name='seller']").val() === "bad") {
            showbad();
        }

        if ($(".page_ebay .formscreen_ebay input[name='seller']").val() === "good") {
            showgood();
        }
...
function progressbarreset() {
	$('.siteloader__progress_bar_progressive').removeClass('active');
	$('.siteloader__progress_texts').removeClass('active');
}
