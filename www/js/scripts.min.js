...
sr.reveal('.reviews .reviews__card, .detail__header, .detail__reviewinfo, .detail__textblock, .detail__imageblock, .detail__linkblock, .share__block, .share__bottom, .subscribe__form, .topauthors__heading, .interesting__heading, .comments__heading, .comments__block, .comments__firsttext, .comments__loginblock', fooReveal);
