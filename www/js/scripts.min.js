...
$(window).scroll(function(){
    ...
    } else { $(".actions").removeClass("sticky"); }
	if ( scroll >= headerheight+searchheight ) {
...
$('.searchblock__menu [data-value]').click(function(e){
	...
	$(this).parents('.searchblock__menu').find('[data-default]').text(typeval+" "+val);
...
$('.searchblock__menu [data-type]').click(function(e){
	...
	$(this).parents('.searchblock__menu').find('[data-default]').text(typeval);
	$(this).parents('.searchblock__menu').removeClass("active");
})


// Добавить параметр фильтра
$('.searchblock__icon_plus').click(function(){
	$('.searchblock__leftside').addClass('active');
})

// Убрать параметр фильтра
$('.searchblock__icon_minus').click(function(){
...
sr.reveal('.reviews__card', fooReveal);
